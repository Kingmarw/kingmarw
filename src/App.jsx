  ...
  return (
    <div className="relative bg-gradient-to-br from-black via-gray-900 to-black text-white font-sans overflow-x-hidden min-h-screen scroll-smooth">
      ...
      <motion.header
        ...
        className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50 bg-black/30 backdrop-blur-2xl border-b border-gray-700 w-full max-w-5xl"
      >
        <div className="flex items-center justify-center h-16 px-10">
          <motion.nav
            initial="hidden"
            animate="visible"
            variants={stagger}
            className="flex space-x-10 text-sm uppercase tracking-wider"
          >
